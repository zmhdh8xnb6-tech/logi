...
$dadosPaginacao = paginarParcelamentosPorOrgao($pdo, 'Previdência Social e Tributos');
...
<body class="app-layout">
    ...
    <main class="app-main">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="mb-1">Parcelamento Previdência Social / Multas / Tributos</h3>
            ...
            <div class="parcelamento-box">
                <div class="cabecalho-lista d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="parcecancelados_tributos.php" class="btn btn-sm btn-outline-warning">
                            <i class="bi bi-archive"></i> Cancelados
                        </a>
                        <a href="parcliquidados_tributos.php" class="btn btn-sm btn-outline-success">
                            <i class="bi bi-check-circle"></i> Liquidados
                        </a>
                        <?php renderizarBotaoImpressaoParcelamentos('Previdência Social e Tributos'); ?>
                    </div>
                </div>
    ...
    <?php renderizarRevisaoLiquidacoesPendentes('Previdência Social e Tributos'); ?>
