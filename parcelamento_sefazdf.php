...
$dadosPaginacao = paginarParcelamentosPorOrgao($pdo, 'SEFAZ DF');
...
<body class="app-layout">
            ...
            <div class="parcelamento-box">
                <div class="cabecalho-lista d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="d-flex gap-2">
                        <a href="parcecancelados_sefazdf.php" class="btn btn-sm btn-outline-warning">
                            <i class="bi bi-archive"></i> Cancelados
                        </a>
                        <a href="parcliquidados_sefazdf.php" class="btn btn-sm btn-outline-success">
                            <i class="bi bi-check-circle"></i> Liquidados
                        </a>
                        <?php renderizarBotaoImpressaoParcelamentos('SEFAZ DF'); ?>
                    </div>
                </div>
    ...
    <?php renderizarRevisaoLiquidacoesPendentes('SEFAZ DF'); ?>
